...
WebGL is written in GLSL (OpenGL Shading Language),
...
> ```
>
> [![Recording of particle GPGPU demo site](https://r.tsei.jp/note/2025-08-01/20250801_glre5.gif)](https://glre.dev/compute/particles)
>
> - Code: https://github.com/tseijp/glre/blob/main/examples/docs/src/pages/compute/particles.tsx
> - Demo: https://glre.dev/compute/particles
...
Each node in the tree structure is constructed by a [create](https://github.com/tseijp/glre/blob/main/packages/core/src/node/create.ts#L11) function.
