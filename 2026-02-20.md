...
https://zenn.dev/articles/2026-02-21-hono-and-react-realtime-app
...
We walk through how to achieve nearly zero cost authentication and persistence, which are essential for any production service.
...
- After deploying to production, set the same environment variables on the Cloudflare Console as well.
     - When "AUTH_URL" is not localhost, authentication will fail unless it uses https.
